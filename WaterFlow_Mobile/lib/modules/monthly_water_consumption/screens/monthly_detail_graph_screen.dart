...
/// A screen that displays a detailed graph of weekly consumption for a specific month.
class MonthlyDetailGraphScreen extends StatelessWidget {
  /// Default constructor for the screen widget.
  const MonthlyDetailGraphScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // Finds the existing instance of the controller provided by GetX.
    final MonthlyWaterConsumptionController monthlyWaterConsumptionController =
        Get.find<MonthlyWaterConsumptionController>();
           
    // Retrieves arguments (like ID and title) passed from the previous screen.
    final Map<String, dynamic> arguments = Get.arguments;
    final String monthlyId = arguments['id'];
            ...
            child: Center(
              ...
              child: SizedBox(
                ...
                child: FutureBuilder<List<ChartPoint>>(
                  ...
                  future: monthlyWaterConsumptionController
                      .fetchAndProcessGraphData(monthlyId),
