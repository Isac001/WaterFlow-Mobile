/// Represents the data model for a bimonthly water consumption record.
class BimonthlyWaterConsumptionModel {
  ...
  BimonthlyWaterConsumptionModel({
    this.id,
    this.dateLabel,
    this.startDate,
    this.endDate,
  ...
  /// Factory constructor to create a [BimonthlyWaterConsumptionModel] instance from a JSON map.
  /// This is typically used when decoding data from an API response.
  factory BimonthlyWaterConsumptionModel.fromJson(Map<String, dynamic> json) {
    return BimonthlyWaterConsumptionModel(
  ...
  /// Converts the [BimonthlyWaterConsumptionModel] instance into a JSON map.
